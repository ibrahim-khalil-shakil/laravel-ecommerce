                    ...
                    <form action="{{ route('user.update') }}" method="post">
                        ...
                        <div class="card-body row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="fullName" value="{{ old('fullName', $user->name) }}">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea class="form-control" rows="3"
                                    name="fullAddress">{{ old('fullAddress', $user->address) }}</textarea>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="checkbox" name="fullAccess" value="1" @if(old('fullAccess', $user->full_access) == 1) checked @endif data-bootstrap-switch
                                    data-off-color="danger" data-on-color="success">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="status">Status</label>
                                <input type="checkbox" name="status" value="1" @if(old('status', $user->status) == 1) checked @endif data-bootstrap-switch
                                    data-off-color="danger" data-on-color="success">
                            </div>
                        </div>
                        <!-- /.card-body -->
