            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Change and Update User Data</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                        ...
                        <div class="card-body row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" name="fullAccess">
                                    <option value="0" {{ old('fullAccess', $user->full_access) == 0 ? 'selected' : ''
                                        }}>No</option>
                                    <option value="1" {{ old('fullAccess', $user->full_access) == 1 ? 'selected' : ''
                                        }}>Yes</option>
                                </select>
                            </div>
                            <div class="form-group col-md-6">
